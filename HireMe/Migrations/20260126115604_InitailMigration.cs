        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobConnectionId = table.Column<int>(type: "int", nullable: false),
                    FromUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ToUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: false, comment: "Rating from 1 to 5 stars"),
                    Message = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsVisible = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "Set to true by background job after InteractionEndDate"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_JobConnections_JobConnectionId",
                        column: x => x.JobConnectionId,
                        principalTable: "JobConnections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedback_JobConnection_FromUser_Unique",
                table: "Feedbacks",
                columns: new[] { "JobConnectionId", "FromUserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_IsVisible",
                table: "Feedbacks",
                column: "IsVisible");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_JobConnectionId",
                table: "Feedbacks",
                column: "JobConnectionId");
